  ...
  return (
    <div className="space-y-8" id="wardrobe-analytics-module">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white border border-brand-border p-5 rounded-[20px] shadow-[0_4px_12px_rgba(0,0,0,0.01)] space-y-2">
        ...
        <div className="bg-brand-olive text-white p-5 rounded-[20px] shadow-[0_4px_12px_rgba(0,0,0,0.01)] flex flex-col justify-between">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white border border-brand-border p-6 rounded-[20px] shadow-[0_4px_12px_rgba(0,0,0,0.01)] space-y-5">
      ...
      <div className="bg-white border border-brand-border p-6 rounded-[20px] shadow-[0_4px_12px_rgba(0,0,0,0.01)] space-y-4">
